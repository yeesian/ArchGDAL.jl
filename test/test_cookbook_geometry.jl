...
@testset "test_cookbook_geometry.jl" begin
    ...
    @testset "Create Geometry from WKB" begin
        #! format: off
        wkb = [0x01, 0x01, 0x00, 0x00, 0x00, 0x7b, 0x14, 0xae, 0x47, 0x45, 0x78, 0xfa, 0x40, 0xe1, 0x7a, 0x14, 0x2e, 0x21, 0x01, 0x27, 0x41]
        #! format: on
        x, y = 108420.33, 753808.59
    ...
    @testset "Iterate over Geometries in a Geometry" begin
        ...
        AG.fromWKT(wkt) do geom
            ...
            @test AG.toWKT(AG.getgeom(geom, 3)) ==
                  "POINT (1224880.29658521 665143.686015948)"
        end
    end
    ...
    @testset "Calculate Bounding Box of a Geometry" begin
        ...
        expected = AG.createpolygon([
            Float64[1162440, 672081],
            Float64[1195279, 672081],
            Float64[1195279, 647105],
            Float64[1162440, 647105],
            Float64[1162440, 672081],
        ])
    ...
    @testset "Calculate union between two Geometries" begin
        wkt1 = "POLYGON ((1208064.271243039 624154.6783778917, 1208064.271243039 601260.9785661874, 1231345.9998651114 601260.9785661874, 1231345.9998651114 624154.6783778917, 1208064.271243039 624154.6783778917))"
        wkt2 = "POLYGON ((1199915.6662253144 633079.3410163528, 1199915.6662253144 614453.958118695, 1219317.1067437078 614453.958118695, 1219317.1067437078 633079.3410163528, 1199915.6662253144 633079.3410163528)))"
        wkt3 = "POLYGON ((1199915.66622531 614453.958118695,1199915.66622531 633079.341016353,1219317.10674371 633079.341016353,1219317.10674371 624154.678377892,1231345.99986511 624154.678377892,1231345.99986511 601260.978566187,1208064.27124304 601260.978566187,1208064.27124304 614453.958118695,1199915.66622531 614453.958118695))"
