...
@testset "Tables Support" begin
    ...
    @testset "Tables methods" begin
        ...
        @test AG.toWKT(Tables.getcolumn(features[1], 5)) == "LINESTRING (30 10,10 30,40 40)"
        ...
        @test AG.toWKT(Tables.getcolumn(features[1], :linestring)) == "LINESTRING (30 10,10 30,40 40)"
        ...
        @test AG.toWKT(Tables.getcolumn(features[2], 5)) == "LINESTRING (35 15,15 35,45 45)"
        ...
        @test AG.toWKT(Tables.getcolumn(features[2], :linestring)) == "LINESTRING (35 15,15 35,45 45)"
